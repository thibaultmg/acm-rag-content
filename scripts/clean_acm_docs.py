...
def clean_docbook(xml_path):
            ...
            if idx > 0:
                ...
                if prev.tag in (f"{{{NS_URL}}}para", f"{{{NS_URL}}}simpara"):
                    ...
                    if (
                        ...
                        or "screen" in lower_text
                        or "diagram" in lower_text
                        or "image" in lower_text
        ...
        if ulist in children:
            ...
            if idx > 0:
                ...
                if prev.tag in (f"{{{NS_URL}}}para", f"{{{NS_URL}}}simpara"):
                    ...
                    if (
                        text.endswith(":")
                        or "follow" in lower_text
                        or "refer to" in lower_text
                        or "see also" in lower_text
                        or "more details" in lower_text
                        or "additional resources" in lower_text
                    ):
                        parent.remove(prev)
    ...
    links_to_flatten = []
    for link_tag in root.findall(".//db:xref", NS) + root.findall(".//db:link", NS) + root.findall(".//db:ulink", NS):
